...
def solve_iteration(x_values, density_values, momentum_values, energy_values, N, dt, dx, gamma, simulation_time, scheme_name):
	...
	# internal_energy = pressure_values/(gamma-1)
	internal_energy = (energy_values/density_values) - 0.5*(velocity_values**2)

	plt.plot(x_values, density_values[1:-1])
	plt.title("Test Case 2 - {}: Density Variation (N = {})".format(scheme_name, N-1))
	plt.xlabel("x")
	plt.ylabel("Density")
...
saved_graphs_directory = "test_case_2_graphs/"
...
for N in N_values:
	...
	solve_iteration(x_values, density_values, momentum_values, energy_values, N, dt, dx, gamma, simulation_time, "Rusonov")
	solve_iteration(x_values, density_values, velocity_values, energy_values, N, dt, dx, gamma, simulation_time, "LF")
